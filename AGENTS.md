...
See `PLAN.md` for the full architecture (token/cache strategy, tag taxonomy), phase status (Phases 0–4 shipped; Phase 5 — mappings, deploy webhooks, commits — is next), live infrastructure details, and a list of verified Next.js 16 gotchas. Update `PLAN.md` when a phase lands or a decision changes.
